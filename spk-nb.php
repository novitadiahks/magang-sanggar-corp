                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            ...
                            <form action="result-nb.php" method="POST">
                                <table>
                                    <thead>
                                        <th>
                                            <h3>DATA YANG DIKETAHUI (DATA TES)</h3>
                                        </th>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td>Umur</td>
                                            <td>
                                                <select name="umur[]" class="form-select" aria-label="Default select example">
                                                    <option selected></option>
                                                    <option value="1">Muda (<35 Tahun)</option>
                                                    <option value="2">Paruh Baya (35-50 Tahun)</option>
                                                    <option value="3">Tua (>50 Tahun)</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Penghasilan</td>
                                            <td>
                                                <select name="penghasilan[]" class="form-select" aria-label="Default select example">
                                                    <option selected></option>
                                                    <option value="1">Rendah (<3 Juta)</option>
                                                    <option value="2">Sedang (3-10 Juta)</option>
                                                    <option value="3">Tinggi (>10 Juta)</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Hutang Konsumtif</td>
                                            <td>
                                                <select name="hutang[]" class="form-select" aria-label="Default select example">
                                                    <option selected></option>
